...
export const PRIVACY_STATEMENT_URL: string = 'https://developers.redhat.com/article/tool-data-collection';
export const OPT_OUT_INSTRUCTIONS_URL: string = 'https://github.com/redhat-developer/vscode-commons/wiki/Usage-reporting';
